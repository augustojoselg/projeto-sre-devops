...
resource "google_container_cluster" "primary" {
  ...
  master_authorized_networks_config {
    ...
    cidr_blocks {
      cidr_block   = "177.107.0.0/16"
      display_name = "Corporate IP Range"
    }
  }
...
# 23. APLICAÇÃO KUBERNETES NATIVA (REMOVIDO - AGORA EM APPLICATIONS.TF)
# A definição da aplicação foi movida para o arquivo 'applications.tf' para melhor organização.
